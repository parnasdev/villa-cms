                                   ...
                                   <ul class="list-unstyled list-inline">
                                       ...
                                       <div class="col-md-6">
                                           ...
                                           <x-parnas.form-group class="mb-2">
                                               <x-parnas.buttons.button class="btn btn-success btn-sm col-xl-2 col-lg-2 col-6"
                                                                        type="button" wire:click="upload"
                                                                        wire:loading.attr="disabled" wire:target="upload"
                                               >
                                                   ثبت
                                               </x-parnas.buttons.button>
                                               <x-parnas.buttons.button class="btn btn-danger btn-sm col-xl-2 col-lg-2 col-6"
